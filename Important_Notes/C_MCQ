...
1) int main()
{
    ...
    PF("%d ",*ptr++);                   // ( * ( ptr++ ) ), post increment in address.  |0|1|2|3|4|

    PF("%d ",(*ptr)++);                 // first derefrence and then increment in value. |0|2|2|3|4
    
    PF("%d ",*ptr);                     // 
    
    PF("%d ",*++ptr);                   // first derefrence and then increment into value. |0|2|3|3|4

    PF("%d ",++*ptr);                   // First increment into address and then derefrence.
